...
use App\Filament\Blocks\RepeaterBlock;
use App\Filament\Blocks\RichEditorBlock;
...
use App\Forms\Components\Builder as ComponentsBuilder;
    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                ...
                //             ->label("Created at")
                //             ->content(
                //                 fn(Post $record): ?string => $record->created_at
                //                     ?->diffForHumans()
                //             ),
                ...
                //             ->content(
                //                 fn(Post $record): ?string => $record->updated_at
                //                     ?->diffForHumans()
                //             ),
                //     ])
                //     ->columnSpan(["lg" => 1])
        ...
        return $table
            ->columns([
                ...
                Tables\Columns\BadgeColumn::make("status")
                    ->getStateUsing(
                        fn(Post $record): string => $record->published_at
                            ?->isPast()
                            ? "Published"
                            : "Draft"
                    )
